...
class fuzzy_controller(object):
    ...
    def __init__(self,universe_fx,universe_dfx,universe_kp,universe_ki,universe_kd,name1,name2,names):
        ...
        self.rule=[]
        #1
        self.rule += [ctrl.Rule(antecedent=(self.f['nb'] & self.df['nb']), consequent=(self.kp['pb'] ,self.ki['ns'] , self.kd['pm']))]
        self.rule += [ctrl.Rule(antecedent=(self.f['nm'] & self.df['nb']), consequent=(self.kp['pb'] , self.ki['ps'] , self.kd['pm']))]
        self.rule += [ctrl.Rule(antecedent=(self.f['ns'] & self.df['nb']), consequent=(self.kp['pb'] , self.ki['pm'] , self.kd['pm']))]
        ...
        self.rule += [ctrl.Rule(antecedent=(self.f['ps'] & self.df['pb']), consequent=(self.kp['pb'] , self.ki['ps'] , self.kd['pm']))]
        self.rule += [ctrl.Rule(antecedent=(self.f['pm'] & self.df['pb']), consequent=(self.kp['pb'] , self.ki['ps'] , self.kd['pm']))]
        self.rule += [ctrl.Rule(antecedent=(self.f['pb'] & self.df['pb']), consequent=(self.kp['pb'] , self.ki['ns'] , self.kd['pm']))]
