...
class Test_three(object):
	...
	## AGV参数
        ...
        ## 是否启用AGV
        self.agv1_check = tk.IntVar()
        self.check1 = tk.Checkbutton(self.master, text='启用AGV1', variable=self.agv1_check, bg='white',\
                                     onvalue=1, offvalue=0, height=1, width=13).place(x=200, y=70)
        self.agv2_check = tk.IntVar()
        self.check1 = tk.Checkbutton(self.master, text='启用AGV2', variable=self.agv2_check, bg='white',\
                                     onvalue=1, offvalue=0, height=1, width=13).place(x=400, y=70)
        self.agv3_check = tk.IntVar()
        self.check1 = tk.Checkbutton(self.master, text='启用AGV3', variable=self.agv3_check, bg='white',\
                                     onvalue=1, offvalue=0, height=1, width=13).place(x=600, y=70)
	...
	## 布置
        ...
        self.agv1_sensor.set('AGV1力传感器返回值')
        ...
        self.agv2_sensor.set('AGV2力传感器返回值')
        ...
        self.agv3_sensor.set('AGV3力传感器返回值')
        ...
        # 输入坐标值，调试三轴平台
        ## 调试按钮
        self.t_platform_label = tk.Label(self.master, text='运行时间: ', bg='white', font=('Arial', 10), width=14).place(x=50, y=350)
        self.x_platform_label = tk.Label(self.master, text='X轴坐标：', bg='white', font=('Arial', 10), width=14).place(x=50, y=400)
        self.y_platform_label = tk.Label(self.master, text='y轴坐标：', bg='white', font=('Arial', 10), width=14).place(x=50, y=450)
        self.z_platform_label = tk.Label(self.master, text='z轴坐标：', bg='white', font=('Arial', 10), width=14).place(x=50, y=500)
        ## 坐标值
        ...
        self.x1_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.x1_coord).place(x=200, y=400)
        self.x2_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.x2_coord).place(x=400, y=400)
        self.x3_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.x3_coord).place(x=600, y=400)
        self.y1_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.y1_coord).place(x=200, y=450)
        self.y2_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.y2_coord).place(x=400, y=450)
        self.y3_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.y3_coord).place(x=600, y=450)
        self.z1_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.z1_coord).place(x=200, y=500)
        self.z2_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.z2_coord).place(x=400, y=500)
        self.z3_coord_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.z3_coord).place(x=600, y=500)
        self.t_num_ent = tk.Entry(self.master, width=16, font=('Arial', 10), textvariable=self.t_num).place(x=200, y=350)

        # 读取三轴平台坐标值
        self.cur_coord_label = tk.Label(self.master, text='当前坐标', bg='white', font=('Arial', 10), width=14).place(x=50, y=550)
        self.cur_coord1 = tk.StringVar()
        self.cur_coord1.set("接收返回值")
        self.cur_coord1_en = tk.Entry(self.master, width=20, font=('Arial', 10), textvariable=self.cur_coord1).place(x=200, y=550)
        self.cur_coord2 = tk.StringVar()
        self.cur_coord2.set("接收返回值")
        self.cur_coord2_en = tk.Entry(self.master, width=20, font=('Arial', 10), textvariable=self.cur_coord2).place(x=400, y=550)
        self.cur_coord3 = tk.StringVar()
        self.cur_coord3.set("接收返回值")
        self.cur_coord3_en = tk.Entry(self.master, width=20, font=('Arial', 10), textvariable=self.cur_coord3).place(x=600, y=550)
